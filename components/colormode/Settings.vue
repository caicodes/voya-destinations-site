<!-- refactoring for composition api from options version used in ColorModePicker.vue -->
<template>
  <div class="flex w-12 flex-col items-center justify-center bg-accent rounded-full fixed top-4 right-4">
